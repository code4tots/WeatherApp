 ...
 * names. 
 * Interestingly enough, the main method is not here (it's in WeatherFrame).
 * I originally intended to have the main method here, and use WeatherFrame
 * just as a frame, but Netbeans autogenerated the main function for me there
 * so I figured that that was OK.
 * It gets this information using a web service from a WSDL I've found
